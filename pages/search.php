<div class="view-enter search-v3" style="background: var(--bg-main); min-height: 100vh;">
    <header class="home-header-v3">
         ...
         <form action="index.php" method="GET" class="search-bar-v3 stagger-1" style="animation: viewEnter 0.5s ease forwards; opacity: 0; animation-delay: 0.1s;">
            ...
            <button type="button" onclick="askAI()" style="background: none; border: none; padding: 0; color: var(--brand-primary); display: flex; align-items: center; cursor: pointer;">
    ...
    <main style="padding: 0 24px;">
        ...
        <div class="stagger-2" style="margin: 32px 0; animation: viewEnter 0.5s ease forwards; opacity: 0; animation-delay: 0.2s;">
            <div style="display: justify-content: space-between; align-items: center; margin-bottom: 16px;">
                ...
                <button style="border: none; background: none; color: var(--brand-primary); font-size: 11px; font-weight: 950; text-transform: uppercase;">CLEAR</button>
            </div>
        ...
        <div class="stagger-3" style="animation: viewEnter 0.5s ease forwards; opacity: 0; animation-delay: 0.3s;">
            ...
            <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 12px; height: 180px; margin-bottom: 32px;">
                <div onclick="location.href='?page=explore&category=Dairy'" style="grid-column: span 2; background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: 28px; padding: 24px; display: flex; flex-direction: column; justify-content: space-between; cursor: pointer; transition: all 0.3s;" onmouseover="this.style.borderColor='var(--brand-primary)'" onmouseout="this.style.borderColor='var(--border-color)'">
                    <span style="font-size: 36px;">🥛</span>
                    <div>
                        <h4 style="font-size: 18px; font-weight: 900; letter-spacing: -0.01em;">Dairy</h4>
                        <p style="font-size: 10px; color: var(--brand-primary); font-weight: 900; text-transform: uppercase;">+12% Trending</p>
                    </div>
                </div>
                <div onclick="location.href='?page=explore&category=Fruits'" style="grid-column: span 2; background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: 24px; display: flex; align-items: center; justify-content: space-between; padding: 0 24px; cursor: pointer; transition: all 0.3s;" onmouseover="this.style.borderColor='var(--brand-primary)'" onmouseout="this.style.borderColor='var(--border-color)'">
                     <span style="font-weight: 900; font-size: 15px;">Seasonal Picks</span>
                     <span style="font-size: 28px;">🍎</span>
                </div>
                <div onclick="location.href='?page=explore&category=Vegetables'" style="grid-column: span 2; background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: 24px; display: flex; align-items: center; justify-content: space-between; padding: 0 24px; cursor: pointer; transition: all 0.3s;" onmouseover="this.style.borderColor='var(--brand-primary)'" onmouseout="this.style.borderColor='var(--border-color)'">
